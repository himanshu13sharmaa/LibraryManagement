    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-xl border border-gray-100">
                ...
                {error && (
                    <div className="bg-red-50 text-red-700 p-3 rounded-md flex items-center justify-center space-x-2">
                    ...
                    <div className="rounded-md shadow-sm space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="appearance-none relative block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm mt-1"
